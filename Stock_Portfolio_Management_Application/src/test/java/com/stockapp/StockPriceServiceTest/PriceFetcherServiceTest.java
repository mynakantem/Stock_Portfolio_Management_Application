package com.stockapp.StockPriceServiceTest;
...
public class PriceFetcherServiceTest {
    ...
    public void setup() {
        ...
        mockWebClientBuilder = mock(WebClient.Builder.class);  // Not used in this test, but required for constructor
